...
depth_estimater::depth_estimater(){
    sub_rgb = nh.subscribe<sensor_msgs::Image>("/robot_0/image_0", 1, &depth_estimater::rgbImageCallback, this);
    sub_depth = nh.subscribe<sensor_msgs::Image>("/robot_0/depth_0", 1, &depth_estimater::depthImageCallback, this);
}
